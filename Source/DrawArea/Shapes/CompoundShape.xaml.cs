...
namespace WireFrame.DrawArea.Shapes
{
    ...
    public sealed partial class CompoundShape : UserControl, IShape, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty CenterXProperty = DependencyProperty.Register(nameof(CenterX), typeof(double), typeof(CompoundShape), new PropertyMetadata(null));
        public double CenterX { get => (double)GetValue(CenterXProperty); set => SetValue(CenterXProperty, value); }

        // --

        public static readonly DependencyProperty CenterYProperty = DependencyProperty.Register(nameof(CenterY), typeof(double), typeof(CompoundShape), new PropertyMetadata(null));

...
namespace WireFrame.DrawArea.Shapes
{
    public sealed partial class RectangleShape : UserControl, IShape, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty StrokeThicknessProperty = DependencyProperty.Register(nameof(StrokeThickness), typeof(double), typeof(RectangleShape), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CenterXProperty = DependencyProperty.Register(nameof(CenterX), typeof(double), typeof(RectangleShape), new PropertyMetadata(null));
        public double CenterX { get => (double)GetValue(CenterXProperty); set => SetValue(CenterXProperty, value); }

        // --

        public static readonly DependencyProperty CenterYProperty = DependencyProperty.Register(nameof(CenterY), typeof(double), typeof(RectangleShape), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty TransformOriginProperty = DependencyProperty.Register(nameof(TransformOrigin), typeof(Point), typeof(RectangleShape), new PropertyMetadata(null));

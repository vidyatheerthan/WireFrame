...
namespace WireFrame.Controls
{
    public sealed partial class WFCanvas : UserControl, INotifyPropertyChanged
    {
        ...
        public WFCanvas()
        {
            ...
            IFiniteStateMachine selectionState = new SelectionState(new List<object>() { _grid, _scrollViewer, _canvas, _container, _HUD, _shapeHighlight, _shapeSelect });
            ...
            this.stateExecutor.SelectStateGroup(StateExecutor.StateGroup.DrawRectangle);
